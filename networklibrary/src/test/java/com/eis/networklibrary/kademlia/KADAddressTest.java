...
public class KADAddressTest {
    ...
    private final String EXCEPTION_EXPECTED = "Should have thrown an exception";
    private final String EXCEPTION_NOT_EXPECTED = "Should have not thrown an exception";
    private final int FIRST_DIFF_BIT_INDEX_EXPECTED = 12;
    ...
    public void toString_isOk() {
        assertEquals(ADDRESS_1_TO_STRING, KAD_ADDRESS_1.toString());
    }

    @Test
    public void fromHexString_isOk() {
        assertEquals(KAD_ADDRESS_1, KADAddress.fromHexString(ADDRESS_1_TO_STRING));
    }

    @Test
    public void firstDifferentBit_isOk() {
        //Return BIT_LENGTH if addresses are equals
        assertEquals(KADAddress.BIT_LENGTH, KADAddress.firstDifferentBit(KAD_ADDRESS_1, KAD_ADDRESS_1));
        assertEquals(FIRST_DIFF_BIT_INDEX_EXPECTED, KADAddress.firstDifferentBit(KAD_ADDRESS_2, KAD_ADDRESS_3));
    }
    ...
    public void closerToTarget_isOk() {
        assertEquals(KAD_ADDRESS_5, KADAddress.closerToTarget(KAD_ADDRESS_4, KAD_ADDRESS_5, KAD_ADDRESS_1));

        //Returns the first KADAddress param passed
        KAD_ADDRESS_4_2 = KAD_ADDRESS_4;
        assertEquals(KAD_ADDRESS_4, KADAddress.closerToTarget(KAD_ADDRESS_4, KAD_ADDRESS_4_2, KAD_ADDRESS_1));
    }
